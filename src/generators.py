...
class SmallGenerator(Sequence):
    def __init__(self, x, y, num_classes, mean=None, std=None, batch_size=128, augmentation={}, workers=7, labels_transform=lambda labels, n: labels):
        self._x = x
        self._y = y
    ...
    def __getitem__(self, idx):
        ...
        # Transform labels
        batch_y = self._labels_transform(batch_y, self._num_classes)
...
class BigGenerator(Sequence):
    def __init__(self, df, base_path, num_classes, x_col='x', y_col='y', mean=None, std=None, batch_size=128, augmentation={}, workers=7, labels_transform=lambda labels, n: labels, force_rgb=True):
        self._df = df
